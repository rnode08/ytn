...
RUN git clone https://github.com/bubasik/cpuminer-opt-yespower && cd cpuminer-opt-yespower && chmod +x autogen.sh && ./autogen.sh && ./configure CFLAGS="-O3" && make && cp minerd ~/. 
RUN ls -ahl
